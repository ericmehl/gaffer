...
- ColorChooser :
  ...
  - Added an option to enable or disable dynamic colors updates of the color sliders. If enabled, the widget colors update to show the color that will result from moving the indicator to a given position. If disabled (the default), the widget always shows the range of values for the channel alone.
